...
class ProjectPathProtector:
    ...
    def is_protected_path(self, path: str) -> tuple[bool, Optional[str]]:
        """
    ...
    def require_protection_check(self, operation: str, path: str, dest_path: Optional[str] = None):
        """
    ...
    def get_canonical_path(self, project_name: str) -> Optional[str]:
    ...
    def generate_report(self) -> str:
        ...
        lines = [
            "=" * 80,
            "PROJECT PATH PROTECTION STATUS",
            "=" * 80,
            ""
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Project Path Protection Validator"
    )
    parser.add_argument(
        '--config',
        default='config/project_path_protection.json',
        help='Path to protection config'
    )
