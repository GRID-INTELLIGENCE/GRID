...
class AgenticCase(Base):
    ...
    # Timestamps
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow, comment="Case creation timestamp")
    updated_at = Column(DateTime, nullable=True, onupdate=datetime.utcnow, comment="Last update timestamp")
