...
def _prep_config(
    ...
    return {
        "preparedness": {
            ...
            "gates": gates or [
                {
                    "id": "gate_protocol", "name": "Protocol change",
                    "riskTierId": "tier2", "actionRequired": "require_approval",
                    "approvalAuthority": "lab_lead",
                },
                {
                    "id": "gate_capability", "name": "Capability expansion",
                    "riskTierId": "tier3", "actionRequired": "block",
            ...
            "biosecurityScope": biosecurity or {
                "benignOnly": True,
...
class TestRiskTierAndGate(unittest.TestCase):
    ...
    def test_gate_from_dict(self) -> None:
        g = Gate.from_dict({
            "id": "g1", "name": "Test", "riskTierId": "t2",
            "actionRequired": "block", "approvalAuthority": "review",
        })
...
class TestPreparednessFrameworkEnforceBiosecurityScope(unittest.TestCase):
    ...
    def test_all_match_returns_true(self, mock_get_logger: MagicMock) -> None:
        ...
        prep = PreparednessFramework(_prep_config())
        self.assertTrue(prep.enforce_biosecurity_scope(
            benign_only=True, task_scope="optimization_only", controlled_setting=True,
        ))
