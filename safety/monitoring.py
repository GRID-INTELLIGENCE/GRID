...
_monitor_instance: Optional[EnhancedSafetyMonitor] = None
        ...
        while True:
            ...
            if metrics["cognitive_load"] == "critical":
                ...
                await engine.pause_interaction(
                    reason="Critical cognitive load detected",
                    duration=300
                )
            ...
            if metrics["session_duration"] > 3600:  # 1 hour
                ...
                monitor.record_event(SafetyEvent(
                    event_type="session_limit_intervention",
                    severity="warning",
                    user_id=user_id
                ))
