...
class RuleRegistry:
    ...
    def get(self, rule_id: str) -> Optional[SafetyRule]:
        """Get rule by ID."""
        with self._lock:
...
class GuardianEngine:
    ...
    def __init__(self, enable_cache: bool = True):
        ...
        self._cache: Dict[str, Tuple[List[RuleMatch], float]] = {}
    ...
    def quick_check(self, text: str) -> Tuple[bool, Optional[str], Optional[RuleAction]]:
        """
...
_guardian_engine: Optional[GuardianEngine] = None
...
def init_guardian(rules: Optional[List[SafetyRule]] = None) -> GuardianEngine:
