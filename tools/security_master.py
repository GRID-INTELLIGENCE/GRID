...
class SecurityMasterControl:
    ...
    def full_assessment(self) -> None:
        ...
        if status.overall_status == "secure":
            ...
            print("Run: python tools/security_master.py --fortify")
        else:
            print(f"\n{RED}URGENT: Immediate action required!{RESET}")
            print("Run: python tools/security_master.py --emergency")
...
Examples:
  ...
  python tools/security_master.py --emergency
    ...
    parser.add_argument("--full-assessment", action="store_true", help="Run comprehensive security assessment")
    parser.add_argument("--status", action="store_true", help="Show current security status")
    parser.add_argument("--fortify", action="store_true", help="Apply all security hardening measures")
    parser.add_argument("--emergency", action="store_true", help="Activate emergency response mode")
