...
export function parseKnowledgeGraphPayload(data: unknown): KnowledgeGraphPayload {
  if (data === null || typeof data !== "object") {
    throw new Error("Knowledge graph response is not a JSON object");
  }
  const o = data as Record<string, unknown>;
  if (!Array.isArray(o.nodes) || !Array.isArray(o.edges)) {
    throw new Error("Knowledge graph response must include nodes and edges arrays");
  }
  if (o.total_entities !== undefined && typeof o.total_entities !== "number") {
    throw new Error("Knowledge graph total_entities must be a number when present");
  }
...
export function parseKnowledgeGraphStats(data: unknown): KnowledgeGraphStats {
  ...
  const o = data as Record<string, unknown>;
  if (typeof o.total_entities !== "number" || typeof o.total_relationships !== "number") {
    throw new Error(
