...
class BasedpyrightDebugger:
    ...
    def parse_basedpyright_logs(self, log_content: str) -> dict:
        ...
        for line in lines:
            ...
            if match:
                ...
                metrics["long_operations"].append({"type": op_type, "file": file_path, "duration_ms": duration_ms})
            ...
            if match:
                ...
                metrics["heap_overflows"].append(
                    {"used_mb": used_mb, "total_mb": total_mb, "usage_percent": (used_mb / total_mb) * 100}
                )
    ...
    def analyze_slow_files(self, metrics: dict, top_n: int = 20) -> list[dict]:
        ...
        for file_path, times in metrics["slow_files"].items():
            ...
            slow_files.append(
                {"file": file_path, "avg_ms": avg_time, "max_ms": max_time, "total_ms": total_time, "count": len(times)}
            )
    ...
    def generate_report(self, metrics: dict) -> str:
        ...
        if metrics["long_operations"]:
            ...
            if slow_files:
                ...
                for i, file_info in enumerate(slow_files, 1):
                    ...
                    report.append(
                        f"  {i:2d}. {file_info['total_ms']/1000:7.2f}s total "
        ...
        if memory_analysis["status"] == "warning":
            ...
            if memory_analysis["first_overflow"]:
                ...
                report.append(
                    f"  First overflow: {first['used_mb']}MB / {first['total_mb']}MB "
    ...
    def run_analysis(self, log_file: Path | None = None) -> str:
