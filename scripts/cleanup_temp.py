...
CLEANUP_TARGETS = {
    "__pycache__": {"type": "directory", "pattern": "__pycache__", "description": "Python cache directories"},
    "pyc_files": {"type": "file", "pattern": "*.pyc", "description": "Python bytecode files"},
    "basedpyright": {
        "type": "directory",
    ...
    "logs": {"type": "file", "pattern": "*.log", "days_old": 7, "description": "Old log files (7+ days)"},
    "temp_files": {"type": "file", "pattern": ["*.tmp", "*.temp", "*.cache"], "description": "Temporary files"},
}
...
def should_delete(path: Path, days_old: int | None = None) -> bool:
...
def cleanup_pattern(base_path: Path, pattern: dict, workspace_root: Path, dry_run: bool = False) -> dict:
    ...
    results = {"deleted": [], "archived": [], "errors": [], "bytes_freed": 0}
