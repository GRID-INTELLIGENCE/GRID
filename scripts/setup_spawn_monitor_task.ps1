...
.DESCRIPTION
    ...
    - Runs with policy enforcement (CAUTIOUS)
...
$TaskDescription = "Persistent MCP spawn monitor for policy enforcement (AI Safety)"
$PythonPath = & (Join-Path $PSScriptRoot "resolve_python.ps1")
$MonitorScript = "e:\grid\work\wellness_studio\ai_safety\monitoring\spawn_monitor.py"
$WorkingDir = "e:\grid"
...
function Show-TaskStatus {
    ...
    if ($task) {
        ...
        $stateFile = "e:\grid\work\wellness_studio\ai_safety\monitoring\.monitor_state.json"
