...
from ..api_gateway.gateway import APIGateway, ServiceEndpoint, RouteConfig
from ..service_mesh.mesh import ServiceMesh, ServiceRegistration, ServiceType
from ..event_bus.event_system import EventBus, Event, EventPriority
from ..ai_ml.intelligence_system import FrontierIntelligenceSystem, AISafetyLevel, DataSensitivity
...
class ArenaOrchestrator:
    ...
    def __init__(self, config: OrchestratorConfig):
        ...
        self.intelligence_system: Optional[FrontierIntelligenceSystem] = None
