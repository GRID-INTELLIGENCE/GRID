...
class ConnectorError(Exception):
    ...
    def __init__(self, message: str, connector_type: str = None, error_code: str = None):
...
class QueryExecutionError(ConnectorError):
    def __init__(self, message: str, connector_type: str = None, query: str = None):
...
class ConnectorRegistry:
    ...
    def get_connector(self, name: str) -> Optional[BaseDataClient]:
...
class ConnectorHandler:
    ...
    def _format_query_template(self, template: str, parameters: Dict[str, Any]) -> str:
        ...
        try:
            ...
            raise QueryExecutionError(f"Missing parameter: {e}")
...
def get_connector(name: str) -> Optional[BaseDataClient]:
