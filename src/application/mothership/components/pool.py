...
class ComponentPool:
    ...
    async def get_component(self, component_type: Optional[ComponentType] = None) -> Optional[Component]:
    ...
    async def process_with_component(self, data: Any, component_type: Optional[ComponentType] = None) -> Any:
    ...
    async def _scale_up_if_needed(self, component_type: Optional[ComponentType] = None):
...
# Singleton instance
_pool: Optional[ComponentPool] = None
