...
def upgrade() -> None:
    ...
    op.create_index("ix_drt_behavioral_signatures_path_method", "drt_behavioral_signatures", ["path_pattern", "method"])
    op.create_index(
    ...
    op.create_index(
        "ix_drt_attack_vectors_path_method_active", "drt_attack_vectors", ["path_pattern", "method", "active"]
    )
    op.create_index("ix_drt_attack_vectors_severity_active", "drt_attack_vectors", ["severity", "active"])
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(64), primary_key=True),
        sa.Column(
            "signature_id", sa.String(64), sa.ForeignKey("drt_behavioral_signatures.id"), nullable=False, index=True
        ),
        sa.Column(
            "attack_vector_id", sa.String(64), sa.ForeignKey("drt_attack_vectors.id"), nullable=False, index=True
        ),
    ...
    op.create_index("ix_drt_violations_timestamp_score", "drt_violations", ["timestamp", "similarity_score"])
    op.create_index("ix_drt_violations_client_timestamp", "drt_violations", ["client_ip", "timestamp"])
    ...
    op.create_index("ix_drt_escalated_endpoints_active_expires", "drt_escalated_endpoints", ["is_active", "expires_at"])
    op.create_index("ix_drt_escalated_endpoints_path_active", "drt_escalated_endpoints", ["path", "is_active"])
    ...
    op.create_index("ix_drt_false_positives_created_at", "drt_false_positives", ["created_at"])
    op.create_index("ix_drt_false_positives_violation_marked", "drt_false_positives", ["violation_id", "created_at"])
    ...
    op.create_index(
        "ix_drt_false_positive_patterns_rate_active", "drt_false_positive_patterns", ["false_positive_rate", "active"]
    )
